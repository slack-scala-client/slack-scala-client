...
case class EventServerChallenge(token: String,
                                challenge: String,
                                `type`: String)
...
case class EditMessage(user: Option[String],
                       text: String,
                       ts: String)

case class ReplyMarker(user: String,
                       ts: String)

case class ReplyMessage(user: String,
                        text: String,
                        thread_ts: String,
                        reply_count: Int,
...
case class MessageDeleted(ts: String,
                          deleted_ts: String,
                          event_ts: String,
                          channel: String) extends SlackEvent

case class MessageReplied(ts: String,
                          event_ts: String,
                          channel: String,
...
case class BotMessage(ts: String,
                      ...
                      attachments: Option[Seq[Attachment]]) extends SlackEvent
...
case class MessageWithSubtype(ts: String,
                              ...
                              text: String,
                              is_starred: Option[Boolean],
                              messageSubType: MessageSubtype) extends SlackEvent
...
object MessageSubtypes {
  ...
  case class ChannelNameMessage(oldname: String,
                                name: String) extends MessageSubtype {
...
case class UserTyping(channel: String,
                      user: String) extends SlackEvent

case class ChannelMarked(channel: String,
...
case class ChannelHistoryChanged(latest: Long,
                                 ts: String,
...
case class ImHistoryChanged(latest: Long,
                            ts: String,
                            event_ts: String) extends SlackEvent
...
case class MpImOpen(user: String,
                    channel: String,
                    event_ts: String) extends SlackEvent

case class MpImClose(user: String,
                     channel: String,
                     event_ts: String,
...
case class GroupOpen(user: String,
                     channel: String) extends SlackEvent
...
case class GroupHistoryChanged(latest: Long,
                               ts: String,
                               event_ts: String) extends SlackEvent
...
case class FileCommentDeleted(file_id: String,
...
case class TeamDomainChange(url: String,
                            domain: String) extends SlackEvent

case class BotAdded(bot: JsValue // TODO: structure -- https://api.slack.com/events/bot_added
                   ) extends SlackEvent

case class BotChanged(bot: JsValue // TODO: structure -- https://api.slack.com/events/bot_added
                     ) extends SlackEvent
...
case class Reply(ok: Boolean,
                 reply_to: Long,
                 ts: String,
                 text: String) extends SlackEvent

case class AppsChanged(app: App,
                       event_ts: String) extends SlackEvent

case class AppsUninstalled(app_id: String,
                           event_ts: String) extends SlackEvent

case class AppsInstalled(app: App,
                         event_ts: String) extends SlackEvent
...
case class DndUpdatedUser(`type`: String,
                          user: String,
...
case class MemberJoined(user: String,
                        channel: String,
                        inviter: Option[String]) extends SlackEvent

case class MemberLeft(user: String, channel: String) extends SlackEvent

case class Pong(`type`: String,
